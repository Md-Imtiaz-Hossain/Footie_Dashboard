...
import sktech.com.iimtiaz.ui.assignment.codeprovided.*;
import sktech.com.iimtiaz.ui.assignment.codeprovided.gui.AbstractPlayerDashboardPanel;
import sktech.com.iimtiaz.ui.assignment.codeprovided.gui.PlayerEntryDashboard;
import sktech.com.iimtiaz.ui.assignment.gui.PlayerDashboardPanel;
...
public class FootieDashboard {
	...
	private void printQuestionAnswers() {
		...
		System.out.println("The average number of shots on target across the Premier League and La Liga is  " +
				playerCatalog.getMeanAverageValue(PlayerProperty.SHOTSTARGET, League.LIGA));
		System.out.println();
	}
